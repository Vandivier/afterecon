...
<ol>
 	<li>Production functions change at heterogeneous rates, so this makes the usual \"very long run\" definition (all factors can vary, even the production function) empirically not useful</li>
